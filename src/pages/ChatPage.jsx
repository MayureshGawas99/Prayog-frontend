...
import { IoMdClose, IoMdPersonAdd, IoMdSend } from "react-icons/io";
...
const ChatPage = () => {
  ...
  const { commonAxios, user } = useContext(AppContext);
      ...
      <>
        {selectedChat?.isGroupChat ? (
          <div className="flex items-center justify-between px-4 py-2">
            ...
            <div className="p-2 bg-indigo-200 border rounded-lg cursor-pointer hover:bg-indigo-300">
          ...
          <div className="flex items-center justify-between px-4 py-2">
            ...
            <div
              ...
              className="p-2 bg-indigo-200 border rounded-lg cursor-pointer hover:bg-indigo-300"
            >
  ...
  return (
    <div className="flex flex-grow h-full px-6 py-8 bg-gray-100 md:px-16 lg:px-8">
